...
LABEL org.opencontainers.image.title="parkhaus" \
  org.opencontainers.image.description="Appserver parkhaus mit 'hardened' Basis-Image Bun und Debian 13" \
  org.opencontainers.image.version="2026.4.1-trixie" \
  org.opencontainers.image.licenses="GPL-3.0-or-later" \
  org.opencontainers.image.authors="dojo1024@h-ka.de"
