...
/**
 * Das Modul besteht aus der Funktionalität für das erstellen von Base-Urls.
 * @packageDocumentation
 */

import { type HonoRequest } from 'hono';
import { ParkhausService } from '../service/parkhaus-service.mts';
...
export const createBaseUrl: (req: HonoRequest) => string = (
    ...
    if (indexLastSlash > 0) {
        ...
        if (ParkhausService.ID_PATTERN.test(idStr)) {
